...
- **Config-driven** — `Abilities` maps an ability name to its cooldown, damage, and a `Visualizer` function that spawns whatever the ability looks like. Adding an ability means adding an entry, not touching the service or controller.
